...
public:
	...
	static void drawDebugText(ALLEGRO_FONT* pFont, int r, int g, int b, float x, float y, int flags, float vel, float radius, float rotVel, float accel, float alignment, float cohesion, float seperation);
